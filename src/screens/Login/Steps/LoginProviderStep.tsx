    ...
    return (
        <div style={{ display: "flex", flexDirection: "column", gap: t.spacing.m }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: t.spacing.m }} >
                ...
                <CommunityCard id={"test"} title={"Localhost"} iconRender={<AtSymbolIcon color={t.colors.text.default} width={20} />} subtitle={"Localhost"} onClick={() => selectLoginProvider("http://localhost:11200")} />
