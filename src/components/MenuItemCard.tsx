...
function MenuItemCard({ title, subtitle, iconUrl, iconRender, active, onClick }: CommunityItemProps) {
    const [t] = useTheme();

    return (
        <Link style={{ paddingLeft: t.spacing.xs, paddingRight: t.spacing.xs, color: active ? t.colors.text.focused : t.colors.text.unfocused }} active={active} onClick={onClick}>
